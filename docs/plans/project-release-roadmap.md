...
| R1-S2 单书工作台 | 正文优先、一个推荐动作、模型来源可追溯 | `S2-01～04` 的细分卡；前两窗补齐 P0 配置/诊断 Backlog | [R1-S2A 14 点](./r1-s2a-sprint-commitment.md)、[R1-S2B 9 点](./r1-s2b-sprint-commitment.md)、[R1-S2C 8 点](./r1-s2c-sprint-commitment.md)、[R1-S2D 9 点](./r1-s2d-sprint-commitment.md)已通过；03b 与 04b3 等后续卡等待 Planning |
