...
| R1-S2 单书工作台 | 正文优先、一个推荐动作、模型来源可追溯 | `S2-01～04` 的细分卡；前两窗补齐 P0 配置/诊断 Backlog | S2A～S2D 已通过；[R1-S2E 8 点](./r1-s2e-sprint-commitment.md)承诺来源页动作、世界 Prompt 边界与 transport retry 修复，04b3 等后续卡等待 Planning |
