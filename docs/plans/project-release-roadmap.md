...
| R1-S2 单书工作台 | 正文优先、一个推荐动作、模型来源可追溯 | `S2-01～04` 的细分卡；前两窗补齐 P0 配置/诊断 Backlog | S2A～S2E 已通过；[R1-S2F 8 点](./r1-s2f-sprint-commitment.md)接入真实 transport attempt，并并行建立首个世界样本安全提交边界 |
